...
public void setExtent()
{
	...
	// String Testreport="MyReport-"+dateName+;
	 	//String Myreport="Test-Report-\"+datatime+\".html";
	 	//C:\Users\91725\Documents\eclipse\new automationproject\inetbanking\test-output
	 	//htmlReport = new ExtentHtmlReporter(System.getProperty("user.dir")+ "/test-output/Report/MyReport-"+dateName+".html");
	htmlReport = new ExtentHtmlReporter(System.getProperty("user.dir") + "/test-output/ExtentReport.html");
	 	...
	 	htmlReport .loadXMLConfig(System.getProperty("user.dir")+ "/extentreport_config.xml");
